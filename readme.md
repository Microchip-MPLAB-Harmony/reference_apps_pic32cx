...
# MPLAB® Harmony 3 Reference Applications for PIC32CX MCUs
...
This repository contains the MPLAB® Harmony 3 Reference Applications for PIC32CX MCUs.

Reference Applications for PIC32CX MCUs are standalone applications which demonstrates specific features or capabilities of Microchip PIC32CX MCUs. These applications are developed on Microchip's PIC32CX MCU development boards/kits.

In addition to having the MCU, the PIC32CX MCU development boards/kits
...
The additional hardware features are available on the PIC32CX MCU development boards/kits
...
- Applications demonstrating certain capabilities of the PIC32CX MCUs. For example: Low Power applications, etc.
- Applications demonstrating capabilities of Microchip PIC32CX MCU development boards/kits (Curiosity, Nano, etc.) which allows extending hardware capability through mikroBUS Click or Xplained Pro extensions.
- Getting started applications pertaining to the PIC32CX MCU products. These getting started applications demonstrates usage of MPLAB Harmony 3 framework with MCC UI by exercising commonly used peripheral features.
...
| Folder | Description |
| ---| --- |
| apps | 32-bit MCU Example reference applications for PIC32CX MCUs |

## Documentation

Click [here](https://onlinedocs.microchip.com/v2/keyword-lookup?keyword=REFERENCE_APPLICATIONS_FOR_PIC32CX_MCUS_OVERVIEW&redirect=true) to view the online documentation of this repository.

To view the documentation offline, follow these steps:  

 - Download the publication as a zip file from [here](https://onlinedocs.microchip.com/download/GUID-B537FC45-9F42-4E7B-9BA8-949F5243B698?type=webhelp).
