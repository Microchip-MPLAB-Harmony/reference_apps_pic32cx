...
The above application types serve as a reference source to evaluate solutions for PIC32CX MCUs by developing applications using MPLAB Harmony 3 software framework.  
